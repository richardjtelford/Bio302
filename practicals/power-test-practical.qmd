...
Run `biostats.tutorials::power_lm_app()` and explore the effect of the number of observations on the width of the confidence intervals, the proportion of trials that are statistically significant, and the effect size of significant trials.

If you don't have `biostats.tutorials` yet, you can install it with
