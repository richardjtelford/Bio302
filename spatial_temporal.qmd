...
## Identifiying the autocorrelation process


Non-stationary series have an ACF that remains significant at many lags, rather than quickly declining to zero.

Autoregressive processes have an exponentially declining ACF and spikes in the first one or more lags of the PACF.
Number of spikes indicates the order of the autoregression.

Moving average processes have spikes in the first one or more lags of the ACF and an exponentially declining PACF.
Number of spikes indicates the order of the moving average.
